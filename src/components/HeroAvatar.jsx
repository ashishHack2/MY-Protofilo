...
export default function HeroAvatar() {
  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-[480px] mx-auto select-none py-6">
      {/* Outer ambient glow circles */}
      <motion.div
        className="absolute w-72 h-72 sm:w-88 sm:h-88 rounded-full pointer-events-none"
        style={{
          background: isDark
      ...
      {floatingTags.map((tag) => (
        <motion.div
          key={tag.text}
          className={`absolute z-20 hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full backdrop-blur-md shadow-md border text-xs font-mono font-medium pointer-events-none transition-colors duration-300 ${
            !isDark
      ...
      >
        ...
        <div className="relative w-full flex justify-center">
          <img
            ...
            className={`w-[300px] sm:w-[380px] md:w-[420px] h-auto object-contain transition-all duration-300 ${
              !isDark
        ...
        <motion.div
          ...
          className={`mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border shadow-md backdrop-blur-md text-xs font-mono transition-colors duration-300 ${
            !isDark
        ...
        >
          ...
          <span>Coding scalable backends & AI models</span>
        </motion.div>
      </motion.div>
    </div>
  );
