...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-[#0A0E14] border-t border-slate-200 dark:border-brand-violet/10 py-10 sm:py-12 relative overflow-hidden transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10 flex flex-col items-center justify-center">
        <Link
          to="hero"
          smooth={true}
          duration={500}
          className="text-2xl sm:text-3xl font-display font-bold text-slate-900 dark:text-white cursor-pointer select-none tracking-tighter mb-5 sm:mb-6 transition-colors"
        >
          AB<span className="text-brand-teal">.</span>
        </Link>
        
        <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mb-6 sm:mb-8 text-xs sm:text-sm font-medium">
